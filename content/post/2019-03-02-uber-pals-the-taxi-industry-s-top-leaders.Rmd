---
title: Uber & Pals - The Taxi Industry's Top Leaders
author: Fausto Lopez
date: '2019-03-02'
slug: uber-pals-the-taxi-industry-s-top-leaders
categories: []
tags:
  - r
  - taxi
...
```{r pulling_data, echo = F, message=F, fig.width=12, fig.height=5, eval = F}
...
```{r overall, echo = F, message=F, fig.width=12, warning=F, eval = F}
...
```{r, compare_yellow, echo = F, message=F, fig.width=12, warning=F, eval  =F}
...
```{r extracting top players, echo=F, message=F, fig.width=12, warning=F,  eval  =F}
#mark apps-------------------------------
df[,company:=ifelse(
...
```{r, echo=F, message=F, fig.width=12, warning=F,  eval  =F}
